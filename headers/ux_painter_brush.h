  ...
  public:
    ...
    image_block_pattern_source_definition_t(std::string &_description,
        ...
        : paint_definition_base_t(paint_definition_class_t::image_block_pattern,
                                  _description),
          image_buffer(_description, _width, _height) {
      ...
      cairo_pattern_set_filter(
          pattern, static_cast<cairo_filter_t>(filter_options_t::good));
    }
    image_block_pattern_source_definition_t(std::string &_description,
                                            double _width, double _height,
        ...
        : paint_definition_base_t(paint_definition_class_t::image_block_pattern,
                                  _description),
          image_buffer(_description, _width, _height), filter(_filter),
          extend(_extend) {
      pattern = cairo_pattern_create_for_surface(image_buffer.rendered);
    ...
    std::size_t hash_code(void) const noexcept {
      ...
      hash_combine(__value, paint_definition_base_t::hash_code(),
                   std::type_index(typeid(this)), image_buffer.hash_code(),
